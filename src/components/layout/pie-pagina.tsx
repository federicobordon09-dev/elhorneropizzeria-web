          ...
          <ul className="mt-5 space-y-4 text-sm text-muted-foreground">
            ...
            <li className="flex items-center gap-3">
              <a
                ...
                className="inline-flex items-center gap-2.5 rounded-xl bg-[#25D366]/10 px-4 py-2 text-sm font-medium text-[#25D366] ring-1 ring-inset ring-[#25D366]/20 transition-all duration-300 hover:bg-[#25D366]/20 hover:ring-[#25D366]/30"
              >
